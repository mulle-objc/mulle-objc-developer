...
if( NOT OBJC_DEPS_INC)
   if( MULLE_SDE_REFLECT_DIR)
      set( OBJC_DEPS_INC "${CMAKE_CURRENT_SOURCE_DIR}/<|PROJECT_SOURCE_DIR|>/${MULLE_SDE_REFLECT_DIR}/objc-deps.inc")
   else()
      set( OBJC_DEPS_INC "${CMAKE_CURRENT_SOURCE_DIR}/<|PROJECT_SOURCE_DIR|>/reflect/objc-deps.inc")
   endif()
endif()
...
#   )
   ...
   # _2_<|PROJECT_NAME|> is the deps with OBJC_DEPS_INC.
   #
